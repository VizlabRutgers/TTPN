...
void MainWindow::ModeConfigure2()
{
     ...
     mode2rightLayout->addStretch(1);
     mode2rightLayout->addWidget(polybrowser);
...
*/
     ...
     browse1Button->setIcon(QIcon(QPixmap(":/images/browse.png")
                         .scaled(200, 100)));
     ...
     browse2Button->setIcon(QIcon(QPixmap(":/images/browse.png")
                         .scaled(200, 100)));
     ...
     browse3Button->setIcon(QIcon(QPixmap(":/images/browse.png")
                         .scaled(200, 100)));
 ...
 void MainWindow::createActions()
 {
     ...
     openConfAction = new QAction(QIcon("./images/openText.png"), tr("&Open &Conf"), this);
     ...
     /*
     openTextAction = new QAction(QIcon(":/images/openText.png"), tr("&Open &Text"), this);
     ...
     */
     ...
     saveasAction = new QAction(QIcon("./images/save.png"), tr("&Save &As"), this);
     ...
     printAction = new QAction(QIcon("./images/printer.png"), tr("&Print"), this);
     ...
     grabAction = new QAction(QIcon("./images/camera.png"), tr("Snapshot"), this);
     ...
     pointerAction = new QAction(QIcon("./images/pointer2.png"), tr("&Move Item"), this);
     pointerAction->setStatusTip(tr("Move Item by mouse"));
     connect( pointerAction, SIGNAL(triggered()),this, SLOT(pointerbuttonClicked()) );

     clickAction = new QAction(QIcon("./images/click2.png"), tr("Click P/T"), this);
     ...
     clickArcAction = new QAction(QIcon("./images/click.png"), tr("Click Arc"), this);
     ...
     multiselectAction = new QAction(QIcon("./images/multiselect.png"), tr("Multiple Selection"), this);
     ...
     addTextAction = new QAction(QIcon("./images/text.png"), tr("Add Text"), this);
     ...
     addConditionAction = new QAction(QIcon("./images/condition.png"), tr("Add Condition To Item"), this);
     ...
     rotateAction = new QAction(QIcon("./images/rotate.png"), tr("Rotate Item Clockwise"), this);
     ...
     reverserotateAction = new QAction(QIcon("./images/rotate2.png"), tr("Rotate Item Anti-clockwise"), this);
     ...
     mode1Action = new QAction(QIcon("./images/pnt.png"), tr("Switch to Mode1"), this);
     ...
     mode2Action = new QAction(QIcon("./images/data.png"), tr("Switch to Mode2"), this);
 ...
 void MainWindow::createToolbars()
 {
     ...
     clickButton->setIcon(QIcon("./images/click2.png"));
     ...
     arcInfoButton->setIcon(QIcon("./images/click.png"));
     ...
     multiselectButton->setIcon(QIcon("./images/multiselect.png"));
     ...
     reverserotateButton->setIcon(QIcon("./images/rotate2.png"));
     ...
     fillColorToolButton->setIcon(createColorToolButtonIcon(":/images/floodfill.png", QColor(125,125,255,255)));
...
//     nextframebutton->setText("Next");
     nextframebutton->setIcon(QIcon("./images/nextframe.png"));
...
//     previousframebutton->setText("Last");
     ...
     barchartButton->setIcon(QIcon("./images/barchart.png"));
     ...
     filterButton->setIcon(QIcon("./images/filter.png"));
     ...
     activitystateButton->setIcon(QIcon("./images/states.png"));
     ...
     backButton->setIcon(QIcon("./images/goback.png"));
     ...
     multiviewButton->setIcon(QIcon("./images/grid.png"));
     ...
     pnButton->setIcon(QIcon("./images/pn.png"));
